  ...
  const fetchData = async () => {
    try {
      ...
      const [postsResponse, profilesResponse] = await Promise.all([
        fetch('https://xzapi-01e251739139.herokuapp.com/posts'),
        fetch('https://xzapi-01e251739139.herokuapp.com/profiles'),
      ]);
      ...
      const postEntries = postsData.results.map((post) => ({
        ...
        url: `https://xzapi-01e251739139.herokuapp.com/posts/${post.id}`,
      }));
